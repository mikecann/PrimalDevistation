...
namespace PrimalDevistation.Usefuls
{
    public class BloomComponent : DrawableGameComponent
    {
        ...
        protected override void LoadContent()
        {
            ...
            bloomExtractEffect = PrimalDevistation.Instance.CM.Load<Effect>("Shaders/PostProcess/BloomExtract");
            bloomCombineEffect = PrimalDevistation.Instance.CM.Load<Effect>("Shaders/PostProcess/BloomCombine");
            gaussianBlurEffect = PrimalDevistation.Instance.CM.Load<Effect>("Shaders/PostProcess/GaussianBlur");
